//
//  LabServicesTableViewController.swift
//  Seha Khanah
//
...
class LabServicesTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.navigationItem.title = "Test Types".localized
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "LabServicesTableViewCell", for: indexPath)
        if MOLHLanguage.currentAppleLanguage() == "en"
        {
            cell.textLabel?.text = labService![indexPath.row].nameEn
        }else
        {
            cell.textLabel?.text = labService![indexPath.row].nameAr
        }
