//
//  OfferSubCategoryInteractor.swift
//  Seha Khanah
//
...
import SwiftyJSON
import Alamofire
class OfferSubCategoryInteractor {
    func getOfferSubCategories(id:String,
                               completionHandler: @escaping ([OffersCategory]?, Error?) -> Void) {
        AF.request(SehaKhanahRouter.offersForSpecificCategory(id:id )).validate().responseJSON{
            (response) in
